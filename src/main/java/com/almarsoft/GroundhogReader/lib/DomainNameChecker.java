...
public class DomainNameChecker
{
	 ...
	 * @return True iff thisDomainToken matches thatDomainToken, using the wildcard match as specified by RFC2818-3.1.
	 *         For example, f*.com must match foo.com but not bar.com
	 */
