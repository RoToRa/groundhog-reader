	...
	public void onReceive(Context context, Intent intent)
	{
		...
		try
		{
			...
			mServerMessageGetter =
				new ServerMessageGetter(this, null, null, postCallback, postCallback, context, myServerManager, 100,
					false, true) ;
	...
	public void postCheckMessagesCallBack(String status, Integer resultObj)
	{
		...
		if (hasSome)
		{
			...
			PendingIntent contentIntent =
				PendingIntent.getActivity(mContext, 0, notifyIntent, android.content.Intent.FLAG_ACTIVITY_NEW_TASK) ;
