    ...
    extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (mBanType == UsenetConstants.BANNEDTHREADS)
		{
			...
			bannedStringsSet =
			    DBUtils.getBannedThreads(mGroup, getApplicationContext());
		}
		...
		if ((bannedStringsSet == null) || (bannedStringsSet.size() == 0))
			new AlertDialog.Builder(this).setTitle(
			    getString(R.string.nothing_to_do)).setMessage(
			    getString(R.string.there_are_no_bans)).setNeutralButton(
			    getString(R.string.return_),
		...
		else
		{
			...
			mBannedItemsList =
			    new ArrayList<BannedItem>(bannedStringsSet.size());
			...
			mBannedListView.setAdapter(new BannedAdapter(this,
			    R.layout.banned_item, mBannedItemsList));
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		new MenuInflater(getApplication())
		    .inflate(R.menu.banneditemsmenu, menu);
	...
	private class BannedAdapter
	    extends ArrayAdapter<BannedItem>
	{

		private final ArrayList<BannedItem> items;

		public BannedAdapter(Context context, int textViewResourceId,
		    ArrayList<BannedItem> items)
		{
		    ...
		    ViewGroup parent)
		{
			...
			if (it != null)
			{
				...
				final ImageView banimg =
				    (ImageView)v.findViewById(R.id.img_banned);
				...
				else banimg.setImageDrawable(getResources().getDrawable(
